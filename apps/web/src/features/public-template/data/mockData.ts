...
export const INITIAL_SCHOLARSHIPS: Scholarship[] = [
  {
    ...
    participatingUniversities: [
      ...
      {
        id: 'sjtu',
        name: 'جامعة شانغهاي جياو تونغ',
        nameEn: 'Shanghai Jiao Tong University',
        city: 'شانغهاي',
      },
      {
        id: 'ustc',
        name: 'جامعة العلوم والتكنولوجيا الصينية',
...
export const MOCK_COURSES: Course[] = [
  ...
  {
    id: 'c5',
    title: 'دليل المقابلات الشخصية السفارات وتأشيرة الدراسة',
  ...
  {
    id: 'c6',
    title: 'أساسيات التحليل الإحصائي للبحوث الأكاديمية (SPSS & R)',
    titleEn: 'Academic Statistical Analysis Foundations',
    provider: 'معهد تكنولوجيا الأبحاث',
    instructor: 'د. خالد العمري',
    duration: '10 ساعات • 15 درساً',
    lessonsCount: 15,
    level: 'متوسط',
    isFree: true,
    rating: 4.8,
...
export const MOCK_COUNTRIES: CountryDestination[] = [
  {
    ...
    featuredUniversities: [
      { id: 'tsinghua', name: 'جامعة تسينغهوا', nameEn: 'Tsinghua University', meta: 'بكين • جامعة بحثية رائدة عالميًا' },
      { id: 'peking', name: 'جامعة بكين', nameEn: 'Peking University', meta: 'بكين • أعرق الجامعات الصينية' },
      { id: 'fudan', name: 'جامعة فودان', nameEn: 'Fudan University', meta: 'شنغهاي • جامعة بحثية شاملة' },
      { id: 'zhejiang', name: 'جامعة تشجيانغ', nameEn: 'Zhejiang University', meta: 'هانغتشو • رائدة في العلوم والهندسة' },
      { id: 'sjtu', name: 'جامعة شنغهاي جياو تونغ', nameEn: 'Shanghai Jiao Tong University', meta: 'شنغهاي • علوم وهندسة وطب' },
      { id: 'ustc', name: 'جامعة العلوم والتكنولوجيا', nameEn: 'USTC', meta: 'خفي • أبحاث متقدمة وعلوم تطبيقية' },
    ],
