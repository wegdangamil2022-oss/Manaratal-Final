...
export enum InternationalTestCategory {
  ...
  GENERAL_UNDERGRADUATE_ADMISSION = 'GENERAL_UNDERGRADUATE_ADMISSION',
  GRADUATE_ADMISSION = 'GRADUATE_ADMISSION',
  NATIONAL_INTERNATIONAL_ADMISSION = 'NATIONAL_INTERNATIONAL_ADMISSION',
  SPECIALIZED_ADMISSION = 'SPECIALIZED_ADMISSION',
  PROFESSIONAL_LICENSING_CERTIFICATION = 'PROFESSIONAL_LICENSING_CERTIFICATION',
