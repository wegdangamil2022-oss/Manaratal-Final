# AP Exams — Advanced Placement — البيانات الكاملة 2026–2027 / اختبارات 2027

## 1. معلومات الاختبار الأساسية

### تحديث رسمي معتمد — 9 أغسطس 2026
- البرنامج: **Advanced Placement (AP)** من College Board.
- AP ليس اختبار قبول واحدًا مثل SAT أو ACT؛ هو منظومة مقررات وتقييمات على مستوى جامعي في المرحلة الثانوية، وتختلف بنية كل تقييم حسب المادة.
- العام المرجعي لهذا الملف: **2026–2027 / اختبارات مايو 2027**.
...
### حالة التقديم الرسمية لاختبارات 2027
- في مايو 2027 تنتقل اختبارات AP Chinese, French, German, Italian, Japanese وSpanish Language and Culture إلى **Fully Digital** عبر Bluebook، ويُسجَّل الجزء الشفهي داخل التطبيق باستخدام سماعة سلكية بميكروفون.
- **AP Music Theory** يصبح Hybrid Digital في 2027، مع أجزاء رقمية وأجزاء مكتوبة ورقيًا وتسجيل sight-singing في Bluebook.
- **AP Spanish Literature and Culture** يصبح Fully Digital، و**AP Statistics** يصبح Fully Digital بدل Hybrid.
- AP Art and Design يظل Portfolio عبر AP Digital Portfolio، وAP Research لا يملك امتحانًا كتابيًا نهائيًا تقليديًا.
...
### Fully Digital AP Exams لعام 2027
...
### Hybrid Digital AP Exams لعام 2027
...
### تغييرات اختبارات اللغات لعام 2027
...
### قاعدة البنية والمدة
لا توجد مدة أو عدد أسئلة موحد لجميع AP Exams. كل مادة لها Blueprint ومدة ومكونات خاصة بها، ولذلك يجب تخزين البنية على مستوى **المادة/الاختبار الفرعي** لا على مستوى عائلة AP فقط. بعض المواد Fully Digital، وبعضها Hybrid، وبعضها Portfolio أو Performance Tasks.

## 7. الأقسام والمحتوى الأكاديمي والمهارات

### قاعدة المحتوى الأكاديمي
المحتوى والمهارات المقاسة تختلف جذريًا بين مواد AP؛ صفحة عائلة AP يجب أن تعرض المجالات والمواد، بينما صفحة كل مادة تحفظ الوحدات، نسب الوزن، أنواع الأسئلة والمهارات الخاصة بها. لا يجوز إنشاء Blueprint موحد مصطنع لجميع مواد AP.

## 8. الأقسام الاختيارية والمهام الخاصة

### الاختبارات المعتمدة على AP Digital Portfolio
...
### هل AP يساعد في القبول حتى دون ائتمان؟
...
### تحديث خدمات الدرجات
- نتائج 2026 أصبحت متاحة بدءًا من **6 يوليو 2026**؛ معظم النتائج تظهر في يوليو، وقد تتأخر بعض النتائج حتى ما بعد ذلك بسبب late testing أو المطابقة أو المعالجة.
- التقرير الرسمي يتضمن تاريخ درجات AP السابق، ما لم تُحجب أو تُلغَ درجات محددة.
- خدمة **Multiple-Choice Rescore** الحالية لنتائج 2026 تكلف 30 دولارًا، وموعدها النهائي 31 أكتوبر، وهي متاحة فقط للاختبارات الورقية المحددة في نموذج College Board؛ يجب إعادة التحقق من نطاق الخدمة لنتائج 2027 بسبب تغييرات أنماط التقديم.
- نسخة Free-Response تكلف 10 دولارات للامتحان، وموعد الطلب المعتاد 15 سبتمبر من سنة الاختبار عندما تكون الاستجابات مؤهلة للإتاحة.

### موعد صدور نتائج 2026
...
### تقويم 2027 الرسمي المختصر
- الاختبارات العادية: **3–7 مايو 2027** و**10–14 مايو 2027**.
- Late Testing: **17–21 مايو 2027**.
- AP Digital Portfolio: Computer Science Principles وSeminar وResearch وWorld Languages PPR في **30 أبريل 2027، 11:59 مساءً ET**؛ وAP Art and Design في **7 مايو 2027، 11:59 مساءً ET**.
- ابتداءً من 2027 تستخدم College Board تسميتي **Session 1 / Session 2**، وقد تختلف أوقات البداية بحسب المنطقة الزمنية؛ المنسق المحلي هو المرجع النهائي للوقت والمكان.

### أسبوع الاختبارات الأول: 3–7 مايو 2027
...
### أسبوع الاختبارات الثاني: 10–14 مايو 2027
...
### مواعيد AP Digital Portfolio لعام 2027
...
### مواعيد الطلب الرسمية 2026–2027
- الموعد المفضل للطلب: **2 أكتوبر 2026**.
- الموعد النهائي لطلبات المقررات السنوية/الخريفية وExam Only: **13 نوفمبر 2026، 11:59 مساءً ET**.
- طلبات مقررات الربيع وتعديلات طلبات الخريف: **12 مارس 2027، 11:59 مساءً ET**.
- آخر موعد لطلب تسهيلات SSD لاختبارات AP: **22 يناير 2027**.
الطالب لا يطلب AP Exam مباشرة من College Board؛ الطلب والإدارة يتمان عبر المدرسة أو مركز/مدرسة تستضيف الاختبار.
...
### الطلاب المستقلون وطلاب التعليم المنزلي
...
### رسوم 2026–2027 الرسمية
- 99 دولارًا لكل اختبار في الولايات المتحدة والأقاليم وكندا ومدارس DoDEA.
- 129 دولارًا لكل اختبار في بقية الدول، مع احتمال اختلاف الرسوم لدى بعض المراكز الدولية المعتمدة.
- Late Order: 40 دولارًا إضافيًا عند انطباقه.
- College Board fee reduction للطالب المؤهل: 37 دولارًا لكل اختبار، وتطبق قواعد المدرسة/الدولة الإضافية عند وجودها.
- في سنة الإطلاق 2026–2027 تُعفى AP Business with Personal Finance وAP Cybersecurity من Unused/Canceled Exam Fee وفق سياسة College Board.

### الرسوم الأساسية للعام 2026–2027
...
### الاختبارات الرقمية مع التسهيلات
...
### كم اختبار AP يجب أن يأخذ الطالب؟
...
### ملاحظة تشغيلية
تفاصيل كل AP subject — مثل Blueprint والمدة والآلة الحاسبة ومواد المرجع والمهام الرقمية — يجب ربطها بسجل المادة نفسها. ملف العائلة يحتفظ بالقواعد المشتركة والتقويم والرسوم والجوائز، ولا يحل محل ملفات المواد الفردية.
